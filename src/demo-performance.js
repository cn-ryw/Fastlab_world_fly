...
export function resolvePerformanceConfig(search = currentSearch()) {
    ...
    return Object.freeze({
        ...
        tileRequestsPerServer,
        preloadRadiusMeters: 300,
        preloadTimeoutMs: 180000,
        preloadFrameDelayMs: 80,
        preloadFaceTileTimeoutMs: 10000,
        preloadFaceTileQuietMs: 400,
        preloadAreaSpacingMeters: 150,
        preloadAreaMaxPositions: 13,
        preloadAreaFaceTimeoutMs: 1500,
        preloadAreaFaceQuietMs: 120,
